      ...
      <section className="py-10 md:py-14">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-teal-50 border border-teal-100 rounded-full text-xs font-semibold text-teal-700 mb-4">
            ...
            <p className="text-slate-500 mt-2 text-sm max-w-md mx-auto">
              Experience our AI ordering assistant yourself &mdash; no signup needed.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="relative">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center mb-4 shadow-lg shadow-green-500/20 group-hover:scale-110 transition-transform duration-300">
                  <MessageCircle className="w-6 h-6 text-white" />
                </div>
                <h3 className="text-lg font-bold text-slate-900 mb-1">WhatsApp Order</h3>
                <p className="text-sm text-slate-500 leading-relaxed mb-4">
                  Send a message and let our AI take your order via WhatsApp.
                </p>
